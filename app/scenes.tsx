...
export function AnswerStory({phase, active}: {phase:number;active:boolean}) {
  ...
  return <div className={'answer-story ' + (active ? 'is-active ' : '') + (phase===1?'agents-overview':'')}>
    ...
    <div className={'story-theatre theatre-' + phase} key={replay}>
      ...
      {phase===1 && <AgentExamples active={active} selected={agentExample} onSelect={setAgentExample}/>}
