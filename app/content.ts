...
export const steps = [
  ...
  { title: 'Thank you.', short: 'Thank you', time: '20 min · Discussion', cue: '“Thank you. What questions do you have?”', notes: 'Reveal the finished Canopy bio supplied by Rob as the payoff to the preceding app demo. The line “Yes, it made my bio, too” is a light callback; it does not imply this file was produced live during the meeting. The original bio is displayed upright and can be opened at full size. Thank the audience and invite questions. Rob Carpenter, Canopy Consulting. Email: rob@frostrivercapital.com. Phone: (303) 358-6128. Use Overview to revisit any part of the presentation during discussion.' },
];
